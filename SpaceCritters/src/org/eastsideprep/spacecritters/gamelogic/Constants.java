...
public class Constants {
    ...
    public static final double deltaT = 5e6;
    public static final double G = 0.8e-6;
    public static final double deltaX = WorldVector.deltaX; 
    ...
    public static boolean searchProjectForAliens = false; // searches whole user folder in addition to aliens folder
